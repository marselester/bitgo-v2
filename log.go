...
// Logger is the Go kit's interface which is mainly used here to debug API responses.
...
// Anyhow I needed to debug API responses and decided to use Logger interface
